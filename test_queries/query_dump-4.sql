		...
		WITH offers_data AS (
			...
			SELECT
				...
				-- joins expects that
				'22edba34-f297-4229-8941-910cd33e7baf' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				...
				'3264900' AS price,
				'NOK' AS currency,
				'https://no-go.kelkoogroup.net/ctl/go/sitesearchGo?.ts=1605867047215&.sig=ROdAojZCl6TuxRhkQKYurIC7510-&affiliationId=96954748&catId=124901&comId=16109413&contextLevel=1&contextOfferPosition=1&contextPageSize=1&country=no&ecs=ok&merchantid=16109413&offerId=e676680e96be95ba3d6edd7bd89520bb&searchId=10769920115530_1605867047208_4254&searchQuery=&service=5&wait=true' AS offer_url,
				'2020-11-20 10:10:47.228370' AS requested_at,
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'5cb9dc72-9276-4e51-a84a-df73e5877d14' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				...
				'2885000' AS price,
				'SEK' AS currency,
				'https://se-go.kelkoogroup.net/ctl/go/sitesearchGo?.ts=1605867047284&.sig=.lxfDxfpMlo6LPtnhsGkGDizgVQ-&affiliationId=96954747&catId=124901&comId=10189823&contextLevel=1&contextOfferPosition=1&contextPageSize=1&country=se&ecs=ok&merchantid=10189823&offerId=be1c7aacb76d62154ecb059737d9dc71&searchId=10769920316398_1605867047275_11676&searchQuery=&service=5&wait=true' AS offer_url,
				'2020-11-20 10:10:47.298096' AS requested_at,
				1::int AS match_score
			UNION ALL
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'd5dcba11-2115-445e-80e8-63cc0d1951ef' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'kelkoo_UK' AS offer_source,
				'Nikon D850 Digital SLR Camera Body' AS retail_prod_name,
				'Parkcameras.com' AS retailer_name,
				'UK' AS country,
				'229900' AS price,
				'GBP' AS currency,
				'https://uk-go.kelkoogroup.net/ctl/go/sitesearchGo?.ts=1605867047662&.sig=cMF_1HT8UKsht_dQD8cHAv23bzg-&affiliationId=96954752&catId=124901&comId=100499638&contextLevel=1&contextOfferPosition=1&contextPageSize=1&country=uk&ecs=ok&merchantid=100499638&offerId=1ed47df6543abc30f990ab8c12bc2ff0&searchId=10769920326141_1605867047493_25156&searchQuery=&service=5&wait=true' AS offer_url,
				'2020-11-20 10:10:47.689812' AS requested_at,
				1::int AS match_score
			UNION ALL
