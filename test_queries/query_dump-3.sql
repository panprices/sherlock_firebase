		...
		WITH offers_data AS (
			...
			SELECT
				...
				-- joins expects that
				'302340fe-e0e7-4e2f-9fbf-72bcb132d771' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'ebay_FR' AS offer_source,
				'Authentique Nikon D850 Digital SLR Camera (Body Only)' AS retail_prod_name,
				'eBay' AS retailer_name,
				'IE' AS country,
				226900 AS price,
				'EUR' AS currency,
				'https://rover.ebay.com/rover/1/709-53476-19255-0/1?ff3=2&toolid=10044&campid=5338271690&customid=&lgeo=1&vectorid=229480&item=112962462630' AS offer_url,
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'3f6f9624-34b0-4306-832e-a0e5a7408b64' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'ebay_FR' AS offer_source,
				'NEW Nikon D850 Digital SLR Camera (Body Only)' AS retail_prod_name,
				'eBay' AS retailer_name,
				'IE' AS country,
				226900 AS price,
				'EUR' AS currency,
				'https://rover.ebay.com/rover/1/709-53476-19255-0/1?ff3=2&toolid=10044&campid=5338271690&customid=&lgeo=1&vectorid=229480&item=264548930664' AS offer_url,
				'2020-11-20T10:02:52Z' AS requested_at,
				NULL::int AS match_score
			UNION ALL
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'9a80cca0-bf63-475b-add6-0f65d7d3c77c' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				...
				224900 AS price,
				'EUR' AS currency,
				'https://rover.ebay.com/rover/1/724-53478-19255-0/1?ff3=2&toolid=10044&campid=5338271690&customid=&lgeo=1&vectorid=229494&item=264534010494' AS offer_url,
				'2020-11-20T10:02:52Z' AS requested_at,
				NULL::int AS match_score
			UNION ALL
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'ad973da0-22df-4ba4-a8ec-2f3e5740b74a' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'ebay_IT' AS offer_source,
				'Genuino Nikon D850 Digital SLR Camera (Body Only)' AS retail_prod_name,
				'eBay' AS retailer_name,
				'IE' AS country,
				224900 AS price,
				'EUR' AS currency,
				'https://rover.ebay.com/rover/1/724-53478-19255-0/1?ff3=2&toolid=10044&campid=5338271690&customid=&lgeo=1&vectorid=229494&item=113991564914' AS offer_url,
				'2020-11-20T10:02:52Z' AS requested_at,
				NULL::int AS match_score
			UNION ALL
