		...
		WITH offers_data AS (
			...
			SELECT
				...
				-- joins expects that
				'dc048f6b-6136-4b24-86e4-fcdb6ca3c587' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'google_shopping_SE' AS offer_source,
				'Samsung Galaxy S20+ Plus G985F-DS 8GB/128GB 4G Dual Sim' AS retail_prod_name,
				'cdon.se' AS retailer_name,
				'SE' AS country,
				'1511900' AS price,
				'SEK' AS currency,
				'https://www.google.com/aclk?sa=L&ai=DChcSEwjjosCO4b7tAhUHnLMKHXG2BUcYABAFGgJxbg&sig=AOD64_1WtVLnca4wif48cyErEdUXLQL6xA&ctype=5&q=&ved=0ahUKEwjmmr2O4b7tAhVRGVkFHWWlAigQ2ikIEw&adurl=' AS offer_url,
				'2020-12-08T16:02:29Z' AS requested_at,
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'09ff3dbb-2b5b-47a5-bb2b-549ca526c492' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'google_shopping_SE' AS offer_source,
				'Samsung Galaxy S20+ Plus G985F-DS 8GB/128GB 4G Dual Sim' AS retail_prod_name,
				...
				'815900' AS price,
				'SEK' AS currency,
				'https://www.google.com/aclk?sa=L&ai=DChcSEwjjosCO4b7tAhUHnLMKHXG2BUcYABAEGgJxbg&sig=AOD64_30vXc19S6WwLmdwxntV9GOKiVxRg&ctype=5&q=&ved=0ahUKEwjmmr2O4b7tAhVRGVkFHWWlAigQ2ikIGA&adurl=' AS offer_url,
				'2020-12-08T16:02:29Z' AS requested_at,
				NULL::int AS match_score
			UNION ALL
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'ebdccccb-8b94-4762-b0b3-ea1962e53a78' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'google_shopping_SE' AS offer_source,
				'Samsung Galaxy S20+ Plus G985F-DS 8GB/128GB 4G Dual Sim' AS retail_prod_name,
				'playthek.com' AS retailer_name,
				'SE' AS country,
				'845429' AS price,
				'SEK' AS currency,
				'https://www.google.com/aclk?sa=L&ai=DChcSEwjjosCO4b7tAhUHnLMKHXG2BUcYABAGGgJxbg&sig=AOD64_3iDfDvyJjrJD8Qrql62z_l3v0DFQ&ctype=5&q=&ved=0ahUKEwjmmr2O4b7tAhVRGVkFHWWlAigQ2ikIGw&adurl=' AS offer_url,
				'2020-12-08T16:02:29Z' AS requested_at,
				NULL::int AS match_score
			UNION ALL
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'e989f4e2-c40a-4f96-87da-93fc37ec6e06' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'google_shopping_SE' AS offer_source,
				'Samsung Galaxy S20+ Plus G985F-DS 8GB/128GB 4G Dual Sim' AS retail_prod_name,
				'mmtelecom.co.uk' AS retailer_name,
				'SE' AS country,
				'731031' AS price,
				'SEK' AS currency,
				'https://www.google.com/aclk?sa=L&ai=DChcSEwjjosCO4b7tAhUHnLMKHXG2BUcYABAHGgJxbg&sig=AOD64_31VIJQMPz171Ao3DUhaz4YNbdOig&ctype=5&q=&ved=0ahUKEwjmmr2O4b7tAhVRGVkFHWWlAigQ2ikIIA&adurl=' AS offer_url,
				'2020-12-08T16:02:29Z' AS requested_at,
				NULL::int AS match_score
			UNION ALL
			...
			SELECT
				-- We need to create a random ID since the existing
				-- joins expects that
				'3e2fbab9-43a2-4f15-8b83-72b09f9118ed' AS offer_id,
				NULL AS updated_at,
				NULL AS product_id,
				'google_shopping_SE' AS offer_source,
				'Samsung Galaxy S20+ Plus G985F-DS 8GB/128GB 4G Dual Sim' AS retail_prod_name,
				'SOTEL' AS retailer_name,
				'SE' AS country,
				'888192' AS price,
				'SEK' AS currency,
				'https://www.google.com/aclk?sa=L&ai=DChcSEwjjosCO4b7tAhUHnLMKHXG2BUcYABAJGgJxbg&sig=AOD64_1dhsmc-VTah5L0eHLbUx0Hwb7Dzg&ctype=5&q=&ved=0ahUKEwjmmr2O4b7tAhVRGVkFHWWlAigQ2ikIJA&adurl=' AS offer_url,
				'2020-12-08T16:02:29Z' AS requested_at,
				NULL::int AS match_score
			UNION ALL
